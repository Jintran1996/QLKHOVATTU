...
{
    public class tracuuxuatnhaptontheoky_soiController : BaseController
    {
        #region Database
        ...
        {
            var locations = soi_.SP_MAKHOBYMANV_LOAD("").ToList();
        ...
        public ActionResult GetList(SearchTraCuuXNKho src)
        {
            ...
            var Lists = soi_.VATTU2026_SP_RPT_BAOCAO_LICHSUXUATNHAP_NVLSOI(src.TUNGAY_, src.DENNGAY_, maKhoCsv,"","","","")
                           .ToList();
